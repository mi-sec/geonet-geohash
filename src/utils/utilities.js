...
/*
 console.log( isValue( NaN ) );
 console.log( isValue( null ) );
 console.log( isValue( undefined ) );
 console.log( isValue( true ) );
 console.log( isValue( false ) );
 console.log( isValue( "" ) );
 console.log( isValue( "abc" ) );
 console.log( isValue( 0 ) );
 console.log( isValue( 123 ) );
 console.log( isValue( [] ) );
 console.log( isValue( {} ) );
 console.log( isValue( new Map() ) );
 console.log( isValue( new Float32Array() ) );
 */
function isValue( ...n ) {
